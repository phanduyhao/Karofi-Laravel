...
class postsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.post.index',compact('posts','cates','locations'),[
    ...
    public function create()
    {
        ...
        $cates = cates::all();
        $locations = locations::all();
        return view('admin.post.create',compact('posts','cates','locations'),[
    ...
    public function show(posts $post)
    {
        ...
        $cates = cates::all();
        $locations = locations::all();
        return view('admin.post.details',compact('posts','post','cates','locations'),[
    ...
    public function edit(posts $post)
    {
        ...
        $cates = cates::all();
        $locations = locations::all();
        return view('admin.post.edit',compact('posts','post','cates','locations'),[
