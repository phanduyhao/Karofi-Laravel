...
<header class="header">
    <div class="container header-container position-relative">
        ...
        <div class="header-icon flex-center-between">
            <a href="" class="header-icon__item search">
            ...
            <a href="" class="header-icon__item cart">
            ...
            @if (Auth::check())
                <a href="/admin" class="header-icon__item account">
            @else
                <a href="/login" class="header-icon__item account">
            @endif
        ...
        <div class="header-icon responsive">
            <button href="" class="bar-actions bar">
            ...
            <div class="header-icon__active d-none flex-center-between">
                <a href="" class="header-icon__item search">
                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.5833 26.9167C21.8426 26.9167 26.9167 21.8426 26.9167 15.5833C26.9167 9.32411 21.8426 4.25 15.5833 4.25C9.32411 4.25 4.25 9.32411 4.25 15.5833C4.25 21.8426 9.32411 26.9167 15.5833 26.9167Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M29.7501 29.75L23.5876 23.5875" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
{{-- Header Responsive --}}
    <div class="container header-responsive  position-relative">
        <button href="" class="bar-actions bar">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128ZM40,72H216a8,8,0,0,0,0-16H40a8,8,0,0,0,0,16ZM216,184H40a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16Z"></path></svg>
        </button>
